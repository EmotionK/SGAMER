...
def gen_metapath(dataset_name):
    ...
    metapath_str_all = ['uici','uibi','cibici','uicibi','ibibi', 'ibici', 'ibiui', 'icibi', 'icici', 'iciui', 'iuiui']
    ...
    metapath_list = [tuple(metapath) for metapath in metapath_list_all]#[('ppp',), ('app', 'pap', 'ppa'), ('ptp', 'tpt'), ('apa', 'pap'),
