...
def output_dir_prepare(args):
    experi_data_dir = os.path.join('../data',args.graph_name, 'experi_data') #data/cora/experi_data
    if not os.path.exists(experi_data_dir):
        os.mkdir(experi_data_dir)
    output_dir = experi_data_dir
    record_dir = os.path.join(output_dir, 'record')#data/cora/experi_data/record
    if not os.path.exists(record_dir):
        os.mkdir(record_dir)
    node_emb_dir = os.path.join(output_dir, 'node_emb') #data/cora/experi_data/node_emb
    if not os.path.exists(node_emb_dir):
        os.mkdir(node_emb_dir)
    log_dir = os.path.join(output_dir, 'log') #data/cora/experi_data/log
...
def main(args):
    ...
    ##  Data preparation
    input_dir = os.path.join('../data',args.graph_name) #data/cora
